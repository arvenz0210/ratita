...
export default function OrderHistoryPage() {
  ...
  const handleDeleteOrder = (orderId: string) => {
    try {
      const updatedOrders = confirmedOrders.filter(order => order.orderId !== orderId)
  ...
  const clearAllOrders = () => {
    if (window.confirm('¿Estás seguro de que quieres eliminar todo el historial de pedidos?')) {
