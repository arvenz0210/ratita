...
import { ArrowLeft, ShoppingCart, TrendingUp, Store } from "lucide-react"
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Encuentra los mejores precios para tu lista</p>
              </div>
            </div>
            {bestStore && (
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
          {comparisonData.stores.map((store) => {
            ...
            return (
              <Card key={store} className={`${isBestStore ? 'ring-2 ring-green-500' : ''}`}>
                ...
                <CardContent>
                  <div className="space-y-2">
                    <div className="flex justify-between">
                      ...
                      <span className={`font-semibold ${isBestStore ? 'text-green-600' : 'text-gray-900'}`}>
                      ...
                      {comparisonData.stores.map((store) => {
                        ...
                        return (
                          <td key={store} className="py-3 px-4">
                            <span className={`${isBestPrice ? 'font-semibold text-green-600' : 'text-gray-900'}`}>
                              {formatPrice(price)}
                            </span>
                          </td>
                        )
